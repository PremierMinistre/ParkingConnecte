...
#define DEVICE_NAME                     "ParkCo_Capt1"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "OC_PFE"                      /**< Manufacturer. Will be passed to Device Information Service. */
#define MODEL_NUM                       "0001"                           /**< Model number. Will be passed to Device Information Service. */
...
// Voir file:///C:/espacesDeTravail/NFR_workspace/nRF51_SDK/documentation/s110/html/a01253.html
...
{
    static ble_date_time_t s_time_stamp = { 2017, 10, 18, 11, 05, 03 };
...
static void services_init(void)
{
    ...
    APP_ERROR_CHECK(err_code);
    // Init Uart service
    //err_code = ble_nus_init (ble_nus_t *p_nus, const ble_nus_init_t *p_nus_init);
//	APP_ERROR_CHECK(err_code);
