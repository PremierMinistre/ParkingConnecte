...
#define LED_START      18//21
#define LED_1          18//21
#define LED_2          19//22
#define LED_3          20//23
#define LED_4          21//24
#define LED_5          22
#define LED_STOP       22//24
...
#define SER_CON_RX_PIN              12    // UART RX pin number.
#define SER_CON_TX_PIN              13    // UART TX pin number.
#define SER_CON_CTS_PIN             15    // UART Clear To Send pin number. Not used if HWFC is set to false.
#define SER_CON_RTS_PIN             14    // UART Request To Send pin number. Not used if HWFC is set to false.
